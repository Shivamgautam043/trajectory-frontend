...
export default async function Home() {
  ...
  const allApps = applicationsResult.success
    ? applicationsResult.data.items
    : [];

  const spotlightApps = allApps
    .filter(
      (app) =>
        app.priority === "HIGH" ||
  ...
  const fullTrend = analyticsResult.success
    ? analyticsResult.data.dailyTrend
    : [];
...
const url =
  "mongodb+srv://shivamg_db_user:F3o8lJeI9aYaC3uP@learnmongo.m2967g7.mongodb.net/?appName=LearnMongo";


const uri = "mongodb+srv://shivamg_db_user:F3o8lJeI9aYaC3uP@learnmongo.m2967g7.mongodb.net/?appName=LearnMongo";
