...
export function SpotlightSection({ apps }: { apps: Application[] }) {
        ...
        {apps.map((app) => (
          ...
          >
            <div className="flex justify-between items-start mb-2">
              ...
              <ArrowRight
                size={16}
                className="text-orange-400 opacity-0 group-hover:opacity-100 transition-opacity -translate-x-2 group-hover:translate-x-0"
              />
            </div>
